            ...
            <div class="col-md-6">
                ...
                <div class="main-card mb-3 card">
                    @foreach($comments as $comment)
                        ...
                        <p class="alert alert-info">{{$comment->user->full_name}} Says "{{$comment->content}}" <br><small>{{$comment->created_at}}</small></p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <tr>
                            ...
                            <td><select class="form-control loop" name="assign_id" required value="{{old('assign_id')}}">
