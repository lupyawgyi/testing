                ...
                <div class="row col-md-12">
                    <div class="col-md-9">
                        <div class="main-card mb-3 card">
                            <div class="card-body"><h3>Transaction Reverse Request</h3>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 ">
                                        <select class="form-control loop" name="error_id" required
                                                value="{{old('error_id')}}">
                                                <option value="2">Transaction Reverse</option>
                                        </select>
                                    </div>
                                </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                function dynamic_field(number) {
                    html = '<tr>';
                    html += '<td><select class="form-control loop" name="product[]" required> <option value="Loan">Loan</option><option value="Saving">Saving</option></td>';
                    html += '<td><input type="text" name="accountID[]" class="form-control" required></td>';
                    html += '<td><input type="text" name="transactionID[]" class="form-control" required/></td>';
                    html += '<td><input type="text" name="amount[]" class="form-control" required/></td>';
                    if (number > 1) {
