            ...
            $(document).ready(function () {
                $('#expect').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'LoanOfficer',name:'LoanOfficer'},
                        {data: 'ExpectedRepaymentDate',name:'ExpectedRepaymentDate'},
                        {data: 'ExpectedRepaymentAmount',name:'ExpectedRepaymentAmount'},
